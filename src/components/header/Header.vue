    ...
    <div class="nav">
      ...
      <ul class="detail">
        <li class="first" v-show="!userInfo.username">
          未<router-link to="/login">登录 <Icon type="person"></Icon></router-link> |<span class="text-color-red"><router-link to="/SignUp">注册 <Icon type="person-add"></Icon></router-link></span>
        </li>
        ...
        <li><router-link to="/">商城招商</router-link></li>
      </ul>
    </div>
  </div>
</template>
